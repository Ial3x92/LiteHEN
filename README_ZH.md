...
ShadowMount+ 位于 **工具箱 → 插件 → ShadowMount+**。一个按钮控制本次会话启停，
...
源码作为 FTP 模块编译进 `util.elf`；同时编译进 util 的还有固定版本
...
- **kvnhrt** — 当前维护者。本仓库的开发、发布与支持均在
  [github.com/kvnhrt/onionHEN](https://github.com/kvnhrt/onionHEN/) 进行。

### 上游

本项目延续自 [aydencharles/onionHEN](https://github.com/aydencharles/onionHEN/)。
感谢 aydencharles 与所有原始贡献者打下的基础。

### 贡献者

<p align="center">
  <a href="https://github.com/kvnhrt/onionHEN/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=kvnhrt/onionHEN" alt="OnionHEN 贡献者"/>
  </a>
</p>
