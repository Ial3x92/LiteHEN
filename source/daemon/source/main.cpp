...
void sig_handler(int signo) {
    ...
    onion_log_emergency("signal %d received; main Lite_HEN has crashed", signo);
...
int main() {
  ...
  onion_log_configure("Lite_HEN", "/data/Lite_HEN/Lite_HEN.log");
  onion_log_configure_crash("/data/Lite_HEN/Lite_HEN_crash.log");
  ...
  LOG_INFO("=========== starting Lite_HEN (0x%X) ... ===========", fw_ver);
  ...
  LOG_INFO("StartUp thread created!! - welcome to Lite_HEN");
