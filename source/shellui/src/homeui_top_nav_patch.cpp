...
constexpr const char *kLite_HENTopNavIconPath =
    "/system_ex/vsh_asset/Lite_HEN.png";
...
static const char kLegacyNewAppErrorSourcePrefix[] =
    "var h=(0,u().memo)((function(){var e=(0,f.useInteractivePress)({link:\"Lite_HEN?NavUI=1\"});return u().default.createElement(d.default,{iconId:{uri:\"/system_ex/vsh_asset/Lite_HEN.png\"},onPress:e,title:\"\",__source:{fileName:_,lineNumber:80}})}));t.ApplicationErrorEventTrigger=h;";
...
static const unsigned char kLegacy2xNewIconOrder[] =
    "[\"Lite_HEN\",\"Search\",\"Settings\",\"Profile\"]"
    "                                 ";
...
static const char kLegacy2xNewButtonSourcePrefix[] =
    "var _=(0,s().memo)((function(){var e=(0,c.useInteractivePress)({link:\"Lite_HEN?NavUI=1\"});return s().default.createElement(l.default,{iconId:{uri:\"/system_ex/vsh_asset/Lite_HEN.png\"},onPress:e,title:\"\",__source:{fileName:f,lineNumber:48}})}));";
...
static const char kLegacy3xNewAppErrorSourcePrefix[] =
    "var E=(0,s().memo)((function(){var e=(0,l.useInteractivePress)({link:\"Lite_HEN?NavUI=1\"});return s().default.createElement(f.default,{iconId:{uri:\"/system_ex/vsh_asset/Lite_HEN.png\"},onPress:e,title:\"\",__source:{fileName:d,lineNumber:77}})}));t.ApplicationErrorEventTrigger=E;";
...
static const char kLegacy5x7xNewAppErrorSourcePrefix[] =
    "var b=(0,u().memo)((function(){var e=(0,c.useInteractivePress)({link:\"Lite_HEN?NavUI=1\"});return u().default.createElement(p.default,{iconId:{uri:\"/system_ex/vsh_asset/Lite_HEN.png\"},onPress:e,title:\"\",__source:{fileName:v,lineNumber:80,columnNumber:10}})}));t.ApplicationErrorEventTrigger=b;";
...
static const char kPlainJsNewAppErrorSourcePrefix[] =
    "var b=(0,a.memo)((function(){var e=(0,d.useInteractivePress)({link:\"Lite_HEN?NavUI=1\"});return(0,f.jsx)(m.default,{iconId:{uri:\"/system_ex/vsh_asset/Lite_HEN.png\"},onPress:e,title:\"\"})}));t.ApplicationErrorEventTrigger=b;";
 ...
 */
static const unsigned char kImageSourceLite_HENButtonBody[] = {
...
static_assert(sizeof(kImageSourceLite_HENButtonBody) == kButtonBodySize);
...
static bool is_homeui_top_nav_icon_source(MonoObject *source) {
  ...
  return Mono_to_String(text).find(kLite_HENTopNavIconPath) !=
         std::string::npos;
}
...
static void ReactButtonShadowNode_SetIconSource_Hook(MonoObject *instance,
  ...
  --depth;
#if SHELL_DEBUG == 1
  LOG_DEBUG("homeui_top_nav_patch: mirrored Lite_HEN icon to invertedIcon");
#endif
}
...
void install_homeui_top_nav_hooks(MonoImage *react_pui) {
  ...
  LOG_DEBUG(installed ? "homeui_top_nav_patch: SetIconSource hooked "
                          "(invertedIcon mirror for Lite_HEN)"
...
void patch_homeui_top_nav(unsigned char *buffer, int *size_ptr,
   ...
   *   body:          full 77-byte useInteractivePress Lite_HEN button
   *   Fps:           restore/leave stock showFps implementation
   *   focus icon:    SetIconSource hook mirrors Lite_HEN.png → invertedIcon
   *
   * Object table still retargets:
   *   iconId string → /system_ex/vsh_asset/Lite_HEN.png
   *   title id      → empty
   *   Trigger AppError string slot → Lite_HEN?NavUI=1 (hook_boot → toolbox)
   *
  ...
  const unsigned char *onion_hen_button_body =
      bytes.requires_image_source_object ? kImageSourceLite_HENButtonBody
  ...
  const BytePatch kPatches[] = {
      ...
      /*
       * Host Lite_HEN on ApplicationErrorEventTrigger (exact 77-byte replace).
       */
      {"AppError Lite_HEN body", profile->offsets.app_error_body,
...
#if SHELL_DEBUG == 1
  LOG_DEBUG("homeui_top_nav_patch: activated Lite_HEN top-nav slot "
              "profile='%s' "
              "(hbc_base=0x%llx)",
              profile->name, (unsigned long long)hbc.base_offset);
#endif
