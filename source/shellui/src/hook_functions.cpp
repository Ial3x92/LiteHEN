...
MonoString *GetString_Hook(MonoObject *Instance, MonoString *str) {
  ...
  //  }
    ...
    // XML title/description literals (e.g. "Lite_HEN 工具箱") are already valid
...
MonoString * CxmlUri_Hook(MonoObject * Instance, MonoString * uri) {
   ...
   * file must remain visible whenever Lite_HEN is not loaded.  CxmlUri is the
...
#endif
    return mono_str_ui("/system_ex/vsh_asset/Lite_HEN.png");
  }
