...
bool init_version_string(const OrbisKernelSwVersion& sw) {
  ...
  /* XOR "Lite_HEN " with SISTR0_I_SEE_YOU. Regenerate: encryptver.py "Lite_HEN " */
  const char enc_ver[] = "\x1c\x27\x3a\x3b\x3c\x78\x1a\x07\x7f"; /* "Lite_HEN " */
