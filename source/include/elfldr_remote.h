/* Litehen: launch ELFs via elfldr sockets.
 *
 * 9020 is Litehen's private runtime loader. 9021 is the legacy/external
...
/**
 * True only if Litehen's private embedded loader answers on 127.0.0.1:9020.
 */
...
/**
 * Stage @elf at @abs_path, launch it exclusively through Litehen :9020, and
