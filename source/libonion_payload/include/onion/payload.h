 ...
 * Lite_HEN only supports bare .elf payloads (no .plugin packages).
 */
#pragma once
...
/**
 * Stage ELF under /data/Lite_HEN/payloads/<key>.elf and launch exclusively via
 * Lite_HEN's private 9020 elfldr. User payloads never fall back to the external
